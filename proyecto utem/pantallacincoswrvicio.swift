...
//    }()
//
//    private let botonCompartir: UIButton = {
...
//    }()
//
//    private let botonVolverInicio: UIButton = {
//        let btn = UIButton(type: .system)
...
//    }()
//
//    private let botonSalir: UIButton = {
//        let btn = UIButton(type: .system)
...
//        botonCompartir.addTarget(self, action: #selector(compartirApp), for: .touchUpInside)
//        botonVolverInicio.addTarget(self, action: #selector(volverAlInicio), for: .touchUpInside)
//        botonSalir.addTarget(self, action: #selector(salirApp), for: .touchUpInside)
...
//        cell.textLabel?.text = "Servicio: \(servicio.nombre)\nFecha: \(fechaConDia) Hora: \(servicio.hora)\nEstado: \(servicio.estado)"
//
...
//        let texto = "Descarga la app de ServiClimas Manzanillo"
